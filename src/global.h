...
constexpr std::string_view SAC_VERSION = "0.7.26";
...
#ifdef __clang__
constexpr std::string_view COMPILER = "Clang " TOSTRING(
  __clang_major__
...
#elifdef __GNUC__
constexpr std::string_view COMPILER = "GCC " TOSTRING(__GNUC__) "." TOSTRING(
  __GNUC_MINOR__
